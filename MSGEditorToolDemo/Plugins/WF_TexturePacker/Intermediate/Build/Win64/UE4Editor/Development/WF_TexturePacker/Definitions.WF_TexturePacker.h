...
#define ORIGINAL_FILE_NAME "UE4Editor-WF_TexturePacker.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME MSGEditorToolDemo
...
#define WF_TEXTUREPACKER_API DLLEXPORT
